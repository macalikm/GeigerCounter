...
//const char* MQTT_HOST = "10.133.133.123";

#define WIFI_ENABLED false
#define WIFI_HOSTNAME "MightyOhm Geiger Counter"
#define WIFI_SSID "QubitsInALab"
#define WIFI_PASSWORD "!!133@ions@PHOTONS@superconducting@197!!"

#define OTA_PASSWORD "OTAPW"

#define MQTT_ENABLED false
#define MQTT_HOST "10.133.133.123"  //"BROKER_IP"
#define MQTT_USER "luser"           //"USERNAME"
